...
public class SpinningTopsGameManager : MonoBehaviourPunCallbacks
{
    ...
    public override void OnJoinedRoom()
    {
        ...
        {
            // uI_InformText.text = "Joined to " + PhotonNetwork.CurrentRoom.Name + ". Esperando a otros jugadores...";
            uI_InformText.text = "Esperando a otros jugadores...";

        }
        else
        {
            uI_InformText.text = "Estas en la Sala: " + PhotonNetwork.CurrentRoom.Name;
